...
class HolidayRepository {
    ...
    async getAllHolidays() {
        return await this.db.collection(contracts_1.COLLECTIONS.HOLIDAYS).get();
    }
    async getHoliday(holidayId) {
        return await this.db.collection(contracts_1.COLLECTIONS.HOLIDAYS).doc(holidayId).get();
    }
}
