...
exports.telegramAuth = (0, https_1.onCall)(
  { secrets: [telegramBotToken], region: contracts_1.FUNCTION_CONFIG.REGION },
  async (request) => {
...
exports.sendEmailOtp = (0, https_1.onCall)(
  ...
  { secrets: [telegramBotToken, resendApiKey], region: contracts_1.FUNCTION_CONFIG.REGION },
  async (request) => {
    const parsed = contracts_1.SendOtpSchema.safeParse(request.data);
    if (!parsed.success) {
      throw new https_1.HttpsError(
        contracts_1.ERROR_CODES.INVALID_ARGUMENT,
        contracts_1.ERROR_MESSAGES.INVALID_EMAIL_FORMAT,
      );
    }
    let botToken;
    let apiKey;
