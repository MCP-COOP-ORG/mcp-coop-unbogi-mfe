...
exports.onGiftCreated = (0, firestore_1.onDocumentCreated)({ document: `${contracts_1.COLLECTIONS.GIFTS}/{giftId}`, region: contracts_1.FUNCTION_CONFIG.REGION }, async (event) => {
