...
exports.ping = exports.notifications = exports.invites = exports.holidays = exports.contacts = exports.gifts = exports.auth = void 0;
 ...
 */
exports.ping = (0, https_1.onRequest)({ cors: ["https://mcpcoop.org"], region: contracts_1.FUNCTION_CONFIG.REGION }, (req, res) => {
    res.status(200).json({
        status: "operational",
        service: "unbogi-core",
        timestamp: Date.now()
